    ...
    <div class="modal" role="dialog" aria-labelledby="send-message">
        ...
        <form>
            <div>
                ...
                <input type="text" id="prenom" name="prenom" placeholder="Prénom" aria-label="First name" aria-labelledby="prenom">
            </div>
            <div>
                <label for="nom">Nom</label>
                <input type="text" id="nom" name="nom" placeholder="Nom" aria-label="Last name" aria-labelledby="nom">
            </div>
            <div>
                <label for="email">Email</label>
                <input type="email" id="email" name="email" placeholder="Email" aria-label="Email" aria-labelledby="email">
            </div>
            <div>
                <label for="message">Votre message</label>
                <input id="message" name="message" placeholder="Votre message" aria-label="Your message" aria-labelledby="message">
            </div>
            <button type="submit" class="contact_button_send" aria-label="Send">Envoyer</button>
        </form>
    </div>
</div>
